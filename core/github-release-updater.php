...
final class WUTM_GitHub_Release_Updater {
    ...
    public function plugin_information($result, $action, $args) {
        ...
        $changelog = '
            <h4>2.1.3</h4><ul><li>移除 WU Toolbox 後台聯絡我們按鈕、視窗與傳送端點。</li><li>常見問題後台選單改名，問題使用單行文字欄位，回答保留內容編輯器。</li><li>重新設計常見問題、退換貨政策與隱私權政策後台欄位及一致的前台樣式。</li><li>前台寬度跟隨主題內容容器，修正 FAQ 文字旋轉與過寬問題。</li><li>補強商品分類選單每項外觀設定的用途說明。</li></ul>
