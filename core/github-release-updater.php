...
final class WUTM_GitHub_Release_Updater {
    ...
    public function plugin_information($result, $action, $args) {
        ...
        $changelog = '
            <h4>2.1.2</h4><ul><li>商品購買量獨立為電商工具模組，保留既有調整值與短代碼。</li><li>修正首頁商品區塊的顏色、查看更多文字與連結設定，預設寬度改為跟隨網站。</li><li>FAQ 與政策內容改用文字編輯器，退換貨政策支援多組說明及詳細內容。</li><li>短代碼模組統一黑、白、淡灰預設色與網站寬度，商品分類設定說明更清楚。</li><li>隱藏 WooCommerce 設定頁的擴充市集連結。</li></ul>
