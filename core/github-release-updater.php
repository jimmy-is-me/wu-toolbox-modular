...
final class WUTM_GitHub_Release_Updater {
    ...
    public function plugin_information($result, $action, $args) {
        ...
        $changelog = '
            <h4>2.1.4</h4><ul><li>隱私權政策簡化為單一大型文字編輯器，並提供完整預設內容。</li><li>既有隱私權前文與清單會自動合併，升級時保留原有資料。</li><li>退換貨政策簡化為可新增的標題與內容。</li><li>常見問題預設開啟第一項，新增單一展開或多項同時展開設定。</li><li>修正商品分類與首頁商品區塊顏色標題位置，查看更多按鈕可清楚設定背景及文字顏色。</li></ul>
