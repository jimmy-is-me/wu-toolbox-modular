...
final class WUTM_GitHub_Release_Updater {
    ...
    public function plugin_information($result, $action, $args) {
        ...
        $changelog = '
            <h4>2.1.5</h4><ul><li>網站修復工具新增 Blocksy 結帳運送標題修復，將 ct-shipping-heading 修正為「運送方式」。</li><li>新增免運門檻提示模組，可為單一費率及自行取貨設定門檻、自動免運與進度提示。</li><li>新增新會員優惠模組，支援首次消費滿額折抵、前台提示、使用鎖定、取消解鎖與紀錄。</li></ul>
