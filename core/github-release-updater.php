...
final class WUTM_GitHub_Release_Updater {
    ...
    public function plugin_information($result, $action, $args) {
        ...
        $changelog = '
            <h4>2.1.6</h4><ul><li>修正首頁商品幻燈片左右按鈕受主題樣式影響而跑位。</li><li>常見問題、退換貨政策與隱私權政策新增最大寬度設定，寬度不超過父頁面，手機保留左右間距。</li><li>完整整理首頁商品區塊的查看更多設定，顏色、文字與連結直接套用於前台按鈕，空白連結自動使用商店頁。</li></ul>
