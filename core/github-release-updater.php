...
final class WUTM_GitHub_Release_Updater {
    ...
    public function plugin_information($result, $action, $args) {
        ...
        $changelog = '
            <h4>2.1.7</h4><ul><li>新增會員點數模組，支援消費回饋、經典結帳折抵、效期、會員紀錄、CSV 匯出與後台手動調整。</li><li>保留原有會員中心與結帳前台樣式，並整合至 WU Toolbox 電商工具卡片及子選單。</li><li>修正模組載入生命週期與訂單建立重複回呼防護，避免同一訂單重複扣除點數。</li></ul>
