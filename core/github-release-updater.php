...
final class WUTM_GitHub_Release_Updater {
    ...
    public function plugin_information($result, $action, $args) {
        ...
        $changelog = '
            <h4>2.1.1</h4><ul><li>統一所有 WU Toolbox 模組設定頁的標題、表格、欄位、按鈕與響應式版面，採用列印訂單收據頁的乾淨風格。</li><li>重新整理首頁商品區塊設定頁的資訊層級、欄位寬度、輪播圖片區與手機版配置。</li><li>隱私權政策預設內容補齊為前言及六項條款，前台改用清楚的純文字條列呈現。</li><li>保留聯絡表單的伺服器端固定 Webhook 設定，管理員無法在後台查看或變更密鑰。</li></ul>
