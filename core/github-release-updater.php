...
final class WUTM_GitHub_Release_Updater {
    ...
    public function plugin_information($result, $action, $args) {
        ...
        $changelog = '
            <h4>2.1.0</h4><ul><li>新增「短代碼注入」分類，排列於「代碼注入」下方。</li><li>新增首頁商品區塊設定，可組合響應式輪播、中間內容、商品來源與商品網格。</li><li>新增獨立的 FAQ、退換貨政策及隱私權政策模組，各自提供內容、色彩與專屬短代碼。</li><li>新增 WooCommerce 多層商品分類手風琴選單，支援目前分類展開、商品數量與外觀設定。</li><li>所有新設定頁採用一致的卡片式繁體中文介面，並加強輸入清理與前台輸出隔離。</li></ul>
