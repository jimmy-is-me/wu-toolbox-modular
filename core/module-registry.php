...
function wutm_modules(): array {
    return [
        ...
        'tree-page-view' => ['name' => '樹狀頁面視圖', 'description' => '以樹狀檢視新增、編輯、搜尋及拖曳排序網站頁面。', 'group' => '後台介面', 'icon' => '🌳', 'settings_url' => 'options-general.php?page=cms-tpv-options'],
        ...
        'points-and-rewards' => ['name' => '紅利點數', 'description' => '設定購物累積點數、點數兌換與會員紅利紀錄。', 'group' => '電商工具', 'icon' => '🎁', 'requires' => 'woocommerce', 'settings_page' => 'spar-settings'],
