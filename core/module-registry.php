...
function wutm_modules(): array {
    return [
        ...
        'site-ai-connector' => ['name' => 'AI 連接器', 'description' => '統一管理 MCP、OpenAPI、Gemini 串接方式、唯讀／讀寫金鑰、IP 白名單與擴充功能開關。', 'group' => 'AI功能', 'icon' => '🤖', 'settings_page' => 'site-ai-connector'],
        'ai-content-tools' => ['name' => 'AI 文章與 FAQ', 'description' => '集中查看文章建立、更新、FAQ 與內容操作工具，並複製完整安全指令。', 'group' => 'AI功能', 'icon' => '📝', 'navigation' => true, 'parent_module' => 'site-ai-connector', 'settings_url' => 'admin.php?page=site-ai-tools&group=content'],
        'ai-seo-tools' => ['name' => 'AI SEO 工具', 'description' => '集中查看 SEO 讀取、缺漏掃描與安全更新工具，以及可直接交給 AI 的 SEO 指令。', 'group' => 'AI功能', 'icon' => '🔎', 'navigation' => true, 'parent_module' => 'site-ai-connector', 'settings_url' => 'admin.php?page=site-ai-tools&group=seo'],
        'ai-media-tools' => ['name' => 'AI 圖片工具', 'description' => '管理圖片上傳、媒體搜尋、精選圖片與替代文字補齊等 AI 工具。', 'group' => 'AI功能', 'icon' => '🖼️', 'navigation' => true, 'parent_module' => 'site-ai-connector', 'settings_url' => 'admin.php?page=site-ai-tools&group=media'],
        'ai-commerce-tools' => ['name' => 'AI 電商工具', 'description' => '集中查看商品、庫存、營運資料與優惠券管理工具；未安裝 WooCommerce 時會標示不可用。', 'group' => 'AI功能', 'icon' => '🛒', 'navigation' => true, 'parent_module' => 'site-ai-connector', 'settings_url' => 'admin.php?page=site-ai-tools&group=commerce'],
