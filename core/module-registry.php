...
function wutm_modules(): array {
    return [
        ...
        'free-shipping-notice' => ['name' => '免運門檻提示', 'description' => '統一設定單一費率、自行取貨與 7-11 超商物流的免運門檻；支援免運折價券、尚差金額與已達免運提示，新會員優惠不影響門檻。', 'group' => '電商工具', 'icon' => '🚚', 'requires' => 'woocommerce', 'settings_page' => 'wu-free-shipping-notice'],
        ...
        'new-member-discount' => ['name' => '新會員優惠', 'description' => '新會員首次消費滿額自動折抵，折扣不影響免運門檻，並記錄使用狀態與取消解鎖。', 'group' => '電商工具', 'icon' => '🎁', 'requires' => 'woocommerce', 'settings_page' => 'wu-new-member-discount'],
