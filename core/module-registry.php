...
function wutm_modules(): array {
    return [
        ...
        'knowledge-base-ai' => ['name' => '知識庫支援 AI 擴充', 'description' => '為知識庫快速支援加入 AI 助理，支援 Gemini、Perplexity、OpenAI、網站內容上下文、額度限制與使用紀錄。', 'group' => 'AI功能', 'icon' => '🧠', 'requires_module' => 'knowledge-base', 'settings_page' => 'wumetax-quick-support-ai'],
