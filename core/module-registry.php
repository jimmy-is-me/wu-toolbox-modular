...
function wutm_modules(): array {
    return [
        ...
        'site-ai-connector' => ['name' => 'AI 連接器', 'description' => '提供 MCP、OpenAPI 與 Gemini 工具規格，以唯讀／讀寫金鑰管理網站資料；內建可直接貼給 AI 的完整指令模板、人工確認流程、SEO 內容與圖片替代文字批次補齊，並記錄寫入操作。', 'group' => 'AI功能', 'icon' => '🤖', 'settings_page' => 'site-ai-connector'],
