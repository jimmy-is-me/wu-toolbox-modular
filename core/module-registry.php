...
function wutm_modules(): array {
    return [
        ...
        'cloudflare-turnstile' => ['name' => 'Cloudflare Turnstile', 'description' => '為登入、註冊、留言與支援的表單加入 Cloudflare Turnstile 驗證。', 'group' => '安全性', 'icon' => '🛡️', 'settings_url' => 'admin.php?page=wu-cloudflare-turnstile'],
        ...
        'delivery-date-slots' => ['name' => '交貨日期和時段', 'description' => '讓顧客在結帳時選擇可交貨日期與時段，並同步顯示於訂單與通知。', 'group' => '電商工具', 'icon' => '📅', 'requires' => 'woocommerce', 'settings_page' => 'wu-delivery-date-slots'],
