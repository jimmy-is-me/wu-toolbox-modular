...
function wutm_render_admin_page(): void {
    ...
    <div class="wrap wutm-wrap">
      ...
      <?php if (!$licensed): ?><div class="notice notice-warning inline"><p><strong>尚未完成授權驗證。</strong>既有模組會繼續運作，但啟用新模組前必須先完成授權。 <a class="button button-small" href="<?php echo esc_url(admin_url('admin.php?page=wu-license')); ?>">前往授權設定</a></p></div><?php endif; ?>
