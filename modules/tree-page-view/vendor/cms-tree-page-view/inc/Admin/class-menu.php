...
class Menu {
	...
	public static function is_one_of_our_pages() {
		...
		if ( $current_screen->id === 'wu-toolbox_page_wu-tree-page-view' || $current_screen->id === 'wu-toolbox-modular_page_wu-tree-page-view' ) {
	...
	public static function get_settings_url() {
		return admin_url( 'admin.php?page=wu-tree-page-view' );
	}
