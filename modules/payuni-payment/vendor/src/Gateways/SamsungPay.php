...
/**
 * SamsungPay class for Samsung Pay payment
 */
class SamsungPay extends GatewayBase {

	const GATEWAY_ID = 'payuni-upp-samsungpay';
	...
	public function __construct() {
		...
		$this->method_title       = __( 'PAYUNi Samsung Pay', 'wpbr-payuni-payment' );
		$this->method_description = __( 'PAYUNi Samsung Pay', 'wpbr-payuni-payment' );
		$this->supports           = array(
			'products',
			'refunds',
		);
	...
	public function init_form_fields() {
		$this->form_fields = include WUTM_PAYUNI_PLUGIN_DIR . 'includes/settings/SamsungPaySetting.php';
	}
