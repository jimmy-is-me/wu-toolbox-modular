...
/**
 * GooglePay class for Google Pay payment
 */
class GooglePay extends GatewayBase {

	const GATEWAY_ID = 'payuni-upp-googlepay';
	...
	public function __construct() {
		...
		add_filter( 'payuni_upp_transaction_args_' . $this->id, array( $this, 'payuni_payment_googlepay_transaction_arrgs' ), 10, 2 );
	}
	...
	public function init_form_fields() {
		$this->form_fields = include WUTM_PAYUNI_PLUGIN_DIR . 'includes/settings/GooglePaySetting.php';
	}
