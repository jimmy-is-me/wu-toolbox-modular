		...
		public static function admin_page() {
			...
			<div class="wrap wuqsa-admin">
				...
				<form method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>" id="wuqsa-settings-form">
					...
					<div class="wuqsa-head"><div><h1>Wumetax AI 助理</h1><p>AI 是 Quick Support 的獨立擴充；未啟用或未設定 API Key 時，前台只保留一般內容搜尋。</p></div><button type="submit" class="button button-primary wuqsa-save">儲存設定</button></div>
