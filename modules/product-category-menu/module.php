...
function wutm_pcm_admin_page(): void {
    ...
    <div class="wutm-pcm-hero"><h1>商品分類選單設定</h1><p>建立支援多層分類與目前分類自動展開的手風琴選單。</p><button type="button" class="wutm-pcm-code" onclick="navigator.clipboard.writeText('[wutm_product_categories]');this.textContent='已複製：[wutm_product_categories]'">[wutm_product_categories]　點擊複製</button></div>
